...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        staffRadio.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, -1, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photo/back.jpg"))); // NOI18N
        jLabel7.setText("jLabel7");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 890, 800));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (username.trim().isEmpty() || password.trim().isEmpty()) {
                ...
                if (passenger != null) {
                    this.dispose();
                    new PassengerView(passenger.getPassengerId()).setVisible(true);
